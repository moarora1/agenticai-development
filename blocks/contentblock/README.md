...
- `_contentblock.json` - Universal Editor component model
- `contentblock.js` - Block decoration logic
- `contentblock.css` - Block styles
- `README.md` - This documentation

## Test Content

Test content is available at: `/drafts/contentblock-test`
