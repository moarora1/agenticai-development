...
export default function decorate(block) {
  ...
  contentWrapper.className = 'content-block-content';

  // Add eyebrow if present
  if (eyebrowRow) {
    const eyebrow = eyebrowRow.querySelector('div');
    if (eyebrow && eyebrow.textContent.trim()) {
      eyebrow.className = 'content-block-eyebrow';
  ...
  if (headingRow) {
    ...
    if (heading) {
      heading.className = 'content-block-heading';
  ...
  if (textRow) {
    ...
    if (text) {
      text.className = 'content-block-text';
  ...
  if (ctaRow) {
    ...
    if (ctaCell) {
      ...
      if (link) {
        link.className = 'content-block-cta button primary';
        ctaCell.className = 'content-block-cta-wrapper';
  ...
  imageWrapper.className = 'content-block-image';
